                    ...
                    <div class="col-md-3">
                        <nav class="navbar bg-light">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('category-product',[ 'id' => $category->id]) }}"><i class="fa fa-shopping-bag"></i>{{ $category->name }}</a>
                                </li>
                               @endforeach
                            </ul>
                        </nav>
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="{{ asset($product->image) }}" height="450" width="300" alt="">
                                </a>
                                <div class="product-action">
                                    <a href="{{ route('direct-add-to-cart',['id' => $product->id]) }}"><i class="fa fa-cart-plus"></i></a>
                                    <a href="#"><i class="fa fa-heart"></i></a>
                                    <a href="#"><i class="fa fa-search"></i></a>
                                </div>
                            </div>
                            <div class="product-price">
                                <h3><span>T.K</span>{{ $product->price }}</h3>
                                <a href ="{{ route('product-detail',['id' => $product->id]) }}" class="btn" href=""><i class="fa fa-shopping-cart"></i>Buy Now</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
                ...
                @foreach($products as $key => $product)
                    <div class="col-lg-3">
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="{{ asset($product->image) }}" height="450" width="300" alt="Product Image">
                                </a>
                                <div class="product-action">
                                    <a href="{{ route('direct-add-to-cart',['id' => $product->id]) }}"><i class="fa fa-cart-plus"></i></a>
                                    <a href="#"><i class="fa fa-heart"></i></a>
