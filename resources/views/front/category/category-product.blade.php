                                ...
                                <div class="product-item">
                                    ...
                                    <div class="product-image">
                                        <a href="{{ route('product-detail',['id' => $product->id]) }}">
                                            <img src="{{ asset($product->image) }}" height="400" width="250"  alt="Product Image">
                                        </a>
                                    ...
                                    <div class="product-price">
                                        ...
                                        <a class="btn" href="{{ route('product-detail',['id' => $product->id]) }}"><i class="fa fa-shopping-cart"></i>Buy Now</a>
                                    </div>
                                </div>
                            </div>
                           @endforeach
                            ...
                            <nav class="navbar bg-light">
                                <ul class="navbar-nav">
                                    ...
                                    @foreach($categories as $key  => $category)
                                        <a class="nav-link" href="{{ route('category-product',[ 'id' => $category->id]) }}"><i class="fa fa-female"></i>{{ $category->name }}</a>
                                    </li>
                                   @endforeach
                                </ul>
                            </nav>
