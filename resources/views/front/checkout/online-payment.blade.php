        ...
        <div class="login">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <form action="https://sandbox.aamarpay.com/index.php" method="POST" class="form-horizontal">
                    @csrf
                    ...
                    <input type="hidden" name="store_id" value="aamarpay"/>
                                ...
                                <input type="hidden" name="success_url" value="http://localhost/ecommerce2/public/confirm-online-payment"/>
