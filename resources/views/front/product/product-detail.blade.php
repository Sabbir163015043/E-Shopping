                            ...
                            <div class="row align-items-center">
                                <div class="col-md-5">
                                    ...
                                    <li>
                                        <a href="optionallink.html">
                                            <img class="etalage_thumb_image" src="{{asset( $sub_Image->sub_Image)}}" height="500" width="250" class="img-responsive" />
                                        </a>
                                    </li>
                                ...
                                <div class="col-md-7">
                                    <div class="product-content">
                                        ...
                                        <input type="submit" value="Add to card" tittle="">
                                        </form>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="tab-content">
                                    <div id="description" class="container tab-pane active">
                                        <h4>Short description : </br>{{ $product->short_description }}</h4>
                                        <h4>Long Description : </br> {{ $product->long_description }}</h4>
                                        <p>
                                        </p>
                                    </div>
                                    ...
                                    <div class="product-item">
                                        ...
                                        <div class="product-image">
                                            <a href="{{ route('product-detail',['id' => $related_product->id]) }}">
                                                <img src="{{ asset($related_product->image) }}" height="300" width="250"  alt="Product Image">
                                            </a>
                                        ...
                                        <div class="product-price">
                                            <h3><span>$</span>{{$related_product->price}}</h3>
